[TMLProject2-f1fd] Operating Details
====================================

Generated On: 2024-11-01 20:52:44 UTC
...
.. important::
   ...
   **not be valid if your [TMLProject2-f1fd] container is NOT running**.

.. tip::
   You must have your [TMLProject2-f1fd] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37011  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Dynamo7001'  \-\-env DOCKERUSERNAME='hooluwole'  \-\-env MQTTUSERNAME='hammed'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hooluwole/TMLProject2-f1fd-amd64 (https://hub.docker.com/r/hooluwole/TMLProject2-f1fd-amd64)
...
.. important::
   docker run -d -p 51155:51155 -p 41917:41917 -p 53099:53099 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=TMLProject2-f1fd \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-TMLProject2-f1fd \-\-env GITUSERNAME=Dynamo7001  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi \-\-env SOLUTIONEXTERNALPORT=51155  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=41917  \-\-env SOLUTIONVIPERVIZPORT=53099 \-\-env DOCKERUSERNAME='hooluwole' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=37011 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hammed' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole/TMLProject2-f1fd-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=53099
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=51155
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hooluwole/TMLProject2-f1fd-amd64
...
It can be accessed by entering: http://localhost:41917
...
.. important::
   http://localhost:53099/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:53099/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:53099/<html file>
...
[TMLProject2-f1fd] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Dynamo7001/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/TMLProject2-f1fd
...
.. important::
   https://TMLProject2-f1fd.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-TMLProject2-f1fd
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=51155, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38659, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37963, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35721, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35599, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38059, HPDEHOST=127.0.1.1, HPDEPORT=38931, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33169

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-494-TMLProject2-f1fd,solution_preprocessing_ai_mqtt_dag-TMLProject2-f1fd, python-preprocess-406-TMLProject2-f1fd,solution_preprocessing_ai_mqtt_dag-TMLProject2-f1fd, python-ai-2945-TMLProject2-f1fd,solution_preprocessing_ai_mqtt_dag-TMLProject2-f1fd, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
